...
export type GetOrderByHashQuery = { __typename?: 'Query', order: { __typename?: 'Order', hash: string, collectionAddress: string, tokenId: string, price: string, startTime: number, endTime: number, nonce: string } };
