...
export type GetTokenQuery = { __typename?: 'Query', token: { __typename?: 'Token', id: string, tokenId: string, tokenUri?: string | null, collection: string, owner: string, image?: string | null, description?: string | null, name?: string | null, bids?: Array<{ __typename?: 'Order', hash: string, collectionAddress: string, price: string, currencyAddress: string }> | null, asks?: Array<{ __typename?: 'Order', hash: string, collectionAddress: string, price: string, currencyAddress: string }> | null, attributes?: Array<{ __typename?: 'TokenAttribute', key: string, value: string, tokenCount: number }> | null } };
...
export type GetTokensQuery = { __typename?: 'Query', tokens: Array<{ __typename?: 'Token', id: string, tokenId: string, tokenUri?: string | null, collection: string, owner: string, image?: string | null, description?: string | null, name?: string | null, bids?: Array<{ __typename?: 'Order', hash: string, price: string, currencyAddress: string }> | null, asks?: Array<{ __typename?: 'Order', hash: string, price: string, currencyAddress: string }> | null, sales?: Array<{ __typename?: 'Order', hash: string, price: string, updatedAt: number }> | null }> };
