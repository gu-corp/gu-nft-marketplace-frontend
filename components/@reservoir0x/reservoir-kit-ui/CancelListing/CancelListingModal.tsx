              ...
              <Flex direction="column">
                ...
                <Box css={{ p: '$4', borderBottom: '1px solid $borderColor' }}>
                  <TokenPrimitive
                    ...
                    currencyContract={listing.currencyAddress}
                    currencyDecimals={18}
                    expires={expires}
                  />
                </Box>
                ...
                >
                  ...
                  <Text style="body2" color="subtle" css={{ mb: 24 }}>
                    <>
                      ...
                      at {listing?.price}{' '}
                      {(currencyOptions.find(currency => currency.contract === listing?.currencyAddress) || currencyOptions[0]).symbol} has been canceled.
                    </>
                  </Text>
